...
use crate::infrastructure::third_party::redis::errors::{CustomResult, ParsingError};
use crate::util::fp_utils::when;
    ...
    Self: 'e + std::fmt::Debug,
{
    ...
    fn encode_to_string_of_xml(&'e self) -> CustomResult<String, ParsingError>
    where
        Self: Serialize,
    {
        todo!()
